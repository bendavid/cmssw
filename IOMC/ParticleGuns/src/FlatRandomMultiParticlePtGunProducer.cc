...
#include "IOMC/ParticleGuns/interface/FlatRandomMultiParticlePtGunProducer.h"
...
FlatRandomMultiParticlePtGunProducer::FlatRandomMultiParticlePtGunProducer(const ParameterSet& pset) : BaseFlatGunProducer(pset) {
  ...
  fMinPt = pgunParams.getParameter<double>("MinPt");
  fMaxPt = pgunParams.getParameter<double>("MaxPt");
...
FlatRandomMultiParticlePtGunProducer::~FlatRandomMultiParticlePtGunProducer() {}

void FlatRandomMultiParticlePtGunProducer::produce(edm::Event & e, 
...
#ifdef DebugLog
  if (fVerbosity > 0)
    std::cout << "FlatRandomMultiParticlePtGunProducer: Begin New Event Generation" << std::endl ; 
#endif
